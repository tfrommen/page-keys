		...
		makepot     : {
			pot: {
				options: {
					cwd        : '..',
					exclude    : [ 'resources' ],
					mainFile   : 'page-keys.php',
					potComments: 'Copyright (C) {{year}} Page Keys\nThis file is distributed under the same license as the Page Keys package.',
					potFilename: '<%= globalConfig.textdomain %>.pot',
					potHeaders : {
						poedit                 : true,
						'report-msgid-bugs-to' : 'https://github.com/tfrommen/page-keys/issues',
